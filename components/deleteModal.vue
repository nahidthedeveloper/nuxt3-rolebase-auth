  ...
  <div>
    ...
    <UModal v-model="isOpen" :ui="{ width: 'w-[340px]' }">
      <div class="p-4 h-44 relative">
        <UButton @click="isOpen = false" icon="gridicons:cross" class="absolute text-2xl top-4 right-4" color="blue" />
        <div class="flex justify-center mb-2">
          <UIcon name="material-symbols:delete-outline" class="w-14 h-14" />
        </div>
        <h1 class="text-center mb-5">Are you sure to delete this user? id: {{ id }}</h1>
